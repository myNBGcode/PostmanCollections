...
> Visit https://developer.nbg.gr/documentation/Confirmation-Funds-API-OAuth2-v2 for the full API documentation
...
**Sandbox Scopes** : openid profile role sandbox-funds-confirmation-api-v2
    
    
**Production Scopes** : openid profile ibank_profile role funds-confirmation-api-v2
